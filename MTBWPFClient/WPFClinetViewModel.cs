...
namespace WPFClient
{
    public class WPFClinetViewModel : INotifyPropertyChanged
    {
        ...
        private string _displayMessages = "";
        ...
        public string DisplayMessages
        {
            ...
            set
            {
                _displayMessages = value;
                OnPropertyChanged("DisplayMessages");
            }
        }
        ...
        //SelectedDeviceChangedCommand
        public ICommand SelectedDeviceChangedCommand
        {
            get
            {
                return new DelegateCommand(SelectedDeviceChangedRaised);
            }
        }
        #endregion
        ...
        private void OnConnectMTBRaised()
        {
            ...
            _mtbConnection.On<string, object>("BroadcastMessage", OnMessageReceived);
        ...
        private async void Initial()
        {
            ...
            {
                List<string> receivedevices = JasonToTConverter<List<string>>(receivedevicesstring);
                foreach (var item in receivedevices)
                {
                    Devices.Add(item);
                }
        ...
        private async Task<string> GetDataFromServer(string baseUri, string childUri)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    //return JasonToTypeConverter<T>(test);
                }
