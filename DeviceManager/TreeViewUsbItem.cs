...
namespace WPFUsbView
{
    ...
    {
        private static UsbDeviceDescriptor? axiocamCamera = null;
        public static UsbDeviceDescriptor? AxiocamCamera
        {
            get
            {
                return axiocamCamera;
            }
        }
                ...
                {   // 增加端口节点
                    ...
                    if (NodeConnectionInfo.ConnectionStatus == USB_CONNECTION_STATUS.DeviceConnected)
                    {
                        ...
                        {   // 产品名称
                            ...
                            if (string.Equals(NodeConnectionInfo.DeviceDescriptor.Product,"Axio Webcam"))
                            {
                                axiocamCamera = NodeConnectionInfo.DeviceDescriptor;
                            }
                        }
